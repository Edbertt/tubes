                                    ...
                                    <div class="demo-box m-t-20">
                                        ...
                                        <div class="table-responsive">
                                            <table id="approvedcomment">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = mysqli_query($con, "Select komentar.id,  komentar.nama_depan,komentar.nama_belakang,komentar.email,komentar.postingDate,komentar.comment,berita.id as postid,berita.judul from  komentar join berita on berita.id=komentar.postId where komentar.status=1");
                                                    $cnt = 1;
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                &nbsp;<a href="manage-comments.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del" onclick="return confirm('Do you really want to delete ?')"> <i class="fas fa-trash" style="color: #f05050"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
