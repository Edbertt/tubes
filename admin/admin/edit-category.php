...
if (strlen($_SESSION['username']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "Update  kategori set CategoryName='$category',Description='$description' where id='$catid'");
        if ($query) {
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <?php
                                    $catid = intval($_GET['cid']);
                                    $query = mysqli_query($con, "Select id,CategoryName,Description,PostingDate,UpdationDate from  kategori where Is_Active=1 and id='$catid'");
                                    $cnt = 1;
                                            ...
                                            <div class="col-md-6">
                                                <form class="form-horizontal" name="category" method="post">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">Kategory</label>
                                                        <div class="col-md-10">
