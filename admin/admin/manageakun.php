...
if (strlen($_SESSION['username']) == 0) {
    ...
    if ($_GET['action'] == 'del' && $_GET['rid']) {
        ...
        echo "<script type='text/javascript'> document.location = 'manageakun.php'; </script>";
    }
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><a href="editakun.php?said=<?php echo htmlentities($row['id']); ?>"><i class="fas fa-pencil-alt" style="color: #29b6f6;"></i></a>
                                                            &nbsp;<a class="confirmation" href="manageakun.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del"> <i class="fas fa-trash" style="color: #f05050"></i></a> </th>
                                                    </tr>
                                                <?php
                                                    $cnt++;
                                                } ?>
