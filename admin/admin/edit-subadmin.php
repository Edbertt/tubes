...
$email=$_POST['emailid'];
$nohp=$_POST['nohp'];
$query=mysqli_query($con,"Update akun set nama_depan='$namad', nama_belakang='$namab', AdminEmailId='$email', no_hp='$nohp'  where id='$aid'");
if($query)
{
...
<strong>Gagal!</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
...
?>
            ...
            <div class="row">
                <div class="col-md-6">
        <form class="form-horizontal needs-validation" name="suadmin" method="post" id="form">
                        <div class="form-group">
                <label class="col-md-2 control-label">Username</label>
                <div class="col-md-10">
                    <input type="text" id="username" class="form-control" value="<?php echo htmlentities($row['AdminUserName']);?>" name="username" required>
                </div>
                        </div>
            ...
            <div class="col-md-10">
            <input type="email" id="email" class="form-control" value="<?php echo htmlentities($row['AdminEmailId']);?>" name="emailid" required>
