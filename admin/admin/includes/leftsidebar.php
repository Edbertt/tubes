<div class="left side-menu">
  ...
  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="far fa-newspaper"></i> <span> Berita </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-post.php">Tambah Berita</a></li>
                                    <li><a href="manage-posts.php">Manage Berita</a></li>
                                     <li><a href="trash-posts.php">Recycle Bin</a></li>
                                </ul>
                            </li>  
   ...
   <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-comments"></i> <span> Komentar </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                  <li><a href="unapprove-comment.php">Waiting for Approval </a></li>
                                    <li><a href="manage-comments.php">Approved</a></li>
                                </ul>
                            </li>   
