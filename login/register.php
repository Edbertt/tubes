							...
							<?php
								require ("../includes/koneksi.php");
									...
									if(isset($_POST['signup'])){	
    									...
    									$sql = "SELECT * FROM akun WHERE AdminUserName = '{$username}' or AdminemailId = '{$email}'";
    									...
    									if(count($errors) === 0)
    									{
        									...
        									$status = "notverified";
        									$sql1 = "INSERT INTO akun(nama_depan,nama_belakang,AdminUserName, AdminPassword, AdminEmailId, no_hp,userType,code,status) VALUES ('$namadepan','$namabelakang','$username', '$encpass', '$email', '$nohp', '$level','$code','$status')";
