								...
								require ("../includes/koneksi.php");
									...
									if(isset($_POST['signup'])){	
    									...
    									if(count($errors) === 0)
    									{
        									...
        									$status = "notverified";
        									$sql1 = "INSERT INTO register(nama_depan,nama_belakang,username, password, email, no_hp, tanggal_lahir,level,code,status) VALUES ('$namadepan','$namabelakang','$username', '$encpass', '$email', '$nohp', '$tanggal', '$level','$code','$status')";
