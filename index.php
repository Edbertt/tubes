  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php"><h2>Alam Indonesia</h2></a>
    ...
    <div class="services">
      ...
      <?php 
          ...
          while($row1=mysqli_fetch_array($query1)){
            $nid= $row1['id'];
            $namakategori = $row1['CategoryName'];
            $_SESSION['CategoryName'] = $namakategori;
      ?>
        <div class="row">
          <div class="col-md-12">
          ...
          <div class="col-md-4">
            <div class="service-item">
              ...
              <div class="down-content">
                ...
                <a href="newsdetail.php?nid=<?php echo htmlentities($row2['id']); ?>" class="filled-button">Read More</a>
              </div>
            </div>
          </div>
    ...
    <?php } ?>
        ...
        <?php 
          // $category1 = "Pulau Jawa";
          $sql3 = "SELECT * FROM kategori WHERE CategoryName = '$namakategori'";
          $query3 = mysqli_query($con, $sql3);
          while($row3=mysqli_fetch_array($query3))
          {
        ?>
          <br>
          <a href="category.php?catid=<?php echo htmlentities($row3['id']) ?>">
            Read More
