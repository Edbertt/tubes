...
if (strlen($_SESSION['username']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $email = $_POST['emailid'];
    $nohp = $_POST['nohp'];
    $query = mysqli_query($con, "Update akun set nama_depan='$namad', nama_belakang='$namab', email='$email', no_hp='$nohp'  where id='$aid'");
    if ($query) {
      unset($_SESSION['suksesList']);
      $_SESSION['suksesList'] = 'Profile berhasil diupdate!';
                  ...
                  <div class="col-md-6">
                    <form class="form-horizontal needs-validation" name="suadmin" method="post" id="editakun" novalidate>
                      <div class="form-group">
                        <label class="col-md-5 control-label form-label" for="username">Username</label>
                        <div class="col-md-10">
                          <input type="text" id="username" class="form-control" value="<?php echo htmlentities($row['username']); ?>" name="username" required readonly>
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-md-5 control-label">Nama Depan</label>
                        <div class="col-md-10">
                      ...
                      <div class="form-group">
                        <label class="col-md-5 control-label">Nama Belakang</label>
                        <div class="col-md-10">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-content">
              ...
              <br><br>
              <h4><b>4. Taman Nasional Pulau Komodo</b></h4>
              ...
              <br><br>
              <h4><b>6. Taman Nasional Way Kambas</b></h4>
                ...
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    ...
                    <p>Sandiaga Salahuddin Uno atau lebih dikenal dengan nama Sandiaga Uno, dilantik oleh Presiden Joko Widodo sebagai Menteri Pariwisata dan Ekonomi Kreatif/Kepala Badan Pariwisata dan Ekonomi Kreatif pada 23 Desember 2020.
                      ...
                      Sementara kolaborasi diperlukan karena untuk memulihkan sektor pariwisata dan ekonomi kreatif dibutuhkan keterlibatan semua pihak.
                    </p>
